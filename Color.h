...
public:
    ...
    vector<Vec3f> static generarColores(){
		vector<Vec3f> colors;
        colors.push_back(scalarToVec(aliceblue));
        colors.push_back(scalarToVec(aqua));
        colors.push_back(scalarToVec(bisque));
        colors.push_back(scalarToVec(blue));
        colors.push_back(scalarToVec(brown));
        colors.push_back(scalarToVec(burlywood));
        colors.push_back(scalarToVec(cadetblue));
        colors.push_back(scalarToVec(chocolate));
        ...
        colors.push_back(scalarToVec(darksalmon));
        colors.push_back(scalarToVec(darkseagreen));
        colors.push_back(scalarToVec(darkslateblue));
        colors.push_back(scalarToVec(dimgrey));
        colors.push_back(scalarToVec(dodgerblue));
        colors.push_back(scalarToVec(firebrick));
        colors.push_back(scalarToVec(floralwhite));
        colors.push_back(scalarToVec(forestgreen));
        colors.push_back(scalarToVec(gainsboro));
        colors.push_back(scalarToVec(ghostwhite));
        colors.push_back(scalarToVec(gold));
        colors.push_back(scalarToVec(honeydew));
        // colors.push_back(scalarToVec(hotpink));
        colors.push_back(scalarToVec(indianred));
        colors.push_back(scalarToVec(indigo));
        colors.push_back(scalarToVec(greenyellow));
        colors.push_back(scalarToVec(ivory));
        colors.push_back(scalarToVec(khaki));
        colors.push_back(scalarToVec(lemonchiffon));
        colors.push_back(scalarToVec(maroon));
        colors.push_back(scalarToVec(mediumaquamarine));
        colors.push_back(scalarToVec(midnightblue));
        colors.push_back(scalarToVec(oldlace));
        colors.push_back(scalarToVec(olive));
        colors.push_back(scalarToVec(orange));
        colors.push_back(scalarToVec(orangered));
        colors.push_back(scalarToVec(palegreen));
        colors.push_back(scalarToVec(peru));
        colors.push_back(scalarToVec(red));
        colors.push_back(scalarToVec(rosybrown));
        colors.push_back(scalarToVec(royalblue));
        colors.push_back(scalarToVec(saddlebrown));
        colors.push_back(scalarToVec(salmon));
        colors.push_back(scalarToVec(sandybrown));
        colors.push_back(scalarToVec(seagreen));
        colors.push_back(scalarToVec(seashell));
        colors.push_back(scalarToVec(sienna));
        colors.push_back(scalarToVec(silver));
        colors.push_back(scalarToVec(skyblue));
        colors.push_back(scalarToVec(slateblue));
        colors.push_back(scalarToVec(slategray));
        colors.push_back(scalarToVec(slategrey));
        colors.push_back(scalarToVec(snow));
        colors.push_back(scalarToVec(springgreen));
        colors.push_back(scalarToVec(steelblue));
        colors.push_back(scalarToVec(Color::tan));
        colors.push_back(scalarToVec(teal));
        colors.push_back(scalarToVec(thistle));
        colors.push_back(scalarToVec(tomato));
        colors.push_back(scalarToVec(turquoise));
        // colors.push_back(scalarToVec(violet));
        colors.push_back(scalarToVec(wheat));
        colors.push_back(scalarToVec(white));
        colors.push_back(scalarToVec(whitesmoke));
        colors.push_back(scalarToVec(yellow));
        colors.push_back(scalarToVec(yellowgreen));
		return colors;
	}
